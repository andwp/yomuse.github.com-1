...
(function ($) {
    $.fn.quovolver = function (options) {
        ...
        return this.each(function () {
            function gotoItem(itemNumber) {
                ...
                var gotoData = {current: $($items[$active - 1]), upcoming: $($items[itemNumber - 1])};
            ...
            function autoPlay() {
                var intervalSpeed = (o.autoPlaySpeed == "auto" ? $items[$active - 1].textLength * 20 + 5000 : o.autoPlaySpeed);
                $box.addClass("play");
            ...
            function fade(data) {
                ...
                data.current.fadeOut(o.transitionSpeed, function () {
                    $this.animate({height: data.upcomingOuterHeight}, o.transitionSpeed, function () {
            ...
            $this.addClass("quovolve").css({position: "relative"}).wrap('<div class="quovolve-box"></div>');
            var groupMethod;
            if (o.children) {
                groupMethod = "find"
            } else {
            ...
            var $box = $this.parent(".quovolve-box"), $items = $this[groupMethod](o.children), $active = 1, $total = $items.length;
    ...
    $.fn.quovolver.defaults = {children: "", transition: "fade", transitionSpeed: 1200, autoPlay: true, autoPlaySpeed: "auto", pauseOnHover: true, stopOnHover: false, equalHeight: true, navPosition: "above", navPositionCustom: "", navPrev: false, navNext: false, navNum: false, navText: false, navPrevText: "Prev", navNextText: "Next", navTextContent: "@a / @b"}
})(jQuery);
